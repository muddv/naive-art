    ...
    return (
        <>
            ...
            <div className="flex flex-col h-44 justify-center align-baseline text-header-black ">
                ...
                <div className="flex flex-row gap-10 justify-center"><span>МАГАЗИН</span> <span>НОВОСТИ</span> <span>ДОСТАВКА</span> <span>КОНТАКТЫ</span> <span>КАК ЗАКАЗАТЬ</span></div>
